...
For a KDE desktop system derived from Debian, the following console command 
...
.. NOTE::
  Another approach is to download :download:`putty-kde.sh <_downloads/putty-kde.sh>` 
  and install the script with the console command::
